...
public class CustomTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    private void init() {
        ...
        if (!isInEditMode()) {
            ...
            if(style == Typeface.BOLD) {
                Typeface tf = Typeface.createFromAsset(getContext().getAssets(), "font/Precious.ttf");
                setTypeface(tf);
            }
        }
    }
    ...
    public void setTypeface(int style){
        ...
        if(style == Typeface.BOLD) {
            super.setTypeface(Typeface.createFromAsset(getContext().getAssets(), "font/Precious.ttf"));
        }
    }
